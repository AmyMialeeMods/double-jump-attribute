package xyz.amymialee.doublejumpattribute.items;
...
public class JumpBootsItem extends ArmorItem {
    ...
    public JumpBootsItem(Settings settings) {
        super(JumpBootsArmourMaterial.INSTANCE, Type.BOOTS, settings);
    ...
    private static class JumpBootsArmourMaterial implements ArmorMaterial {
        private static final JumpBootsArmourMaterial INSTANCE = new JumpBootsArmourMaterial();
